...
<div class="min-h-full text-center relative">
        <div class="mx-auto max-w-5xl px-3 py-6 sm:px-6 lg:px-8 flex items-center justify-center h-screen lg:w-1/2 ">
            <h1 class="text-[12vw] text-gray-300 font-bold absolute transform -translate-y-[190%] mt-10" style="font-family: 'Playfair Display', sans-serif; line-height: 0.9; top: 20%;">
                CONTACT
            </h1>
            <img src="{{ asset('image/home/6.jpg') }}" alt="Collection Image" class="absolute w-[80%] -translate-y-[60%] mx-auto max-w-[35%]">
        </div>

        <div class="contact_us_green mt-[-320px]">
        <div class="responsive-container-block big-container">
            ...
            <div class="responsive-cell-block wk-tab-12 wk-mobile-12 wk-desk-5 wk-ipadp-10" id="ifgi">
                ...
                <div class="text-content">
                    ...
                    <p class="text-blk contactus-subhead">
                        Contact our friendly team for any questions, concerns, or to explore how we can assist in making your furniture dreams come true.
                    </p>
                </div>
